    ...
    <div className="gpt4__blog section__padding" id="blog">
        ...
        <div className="gpt4__blog-container">
          <div className="gpt4__blog-container_groupA">
            <Article imgUrl={blog01} date="Sep26, 23" title="GPT-4 and Open AI is the future. Let us explore how it is?"/>
          </div>
          <div className="gpt4__blog-container_groupB">
            <Article imgUrl={blog02} date="Aug 15, 23" title="GPT-4 and Open AI is the future. Let us explore how it is?"/>
